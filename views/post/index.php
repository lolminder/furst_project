...
<section class="bg-text-area">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="bg-text">
                    <h3>Classic BLOG DesignZALUPA</h3>
            ...
            <div class="blog-post-area-style">
                ...
                <div class="col-md-3">
                    <div class="single-post">
                        ...
                        <h3><a href="<?= \yii\helpers\Url::to(['post/viev','id'=>$post->id ]) ?>"><?=$post->title?></a></h3>
                        <h4><span>Posted By: <span class="author-name"><?= $post->name ?></span></span>
                        </h4>
                        <?=$post->text  ?>
